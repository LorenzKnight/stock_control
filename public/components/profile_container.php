...
<div class="container">
	...
	<div class="data-container flex profile-detail-height" id="profile-data">
		...
		<div class="small-box-container">
			<div class="small-box">
				<div class="box-title">
					<h2><?= htmlspecialchars(tr('smallbox_my_info') ?? 'My Info') ?></h2>
				</div>
			...
			<div class="small-box">
				<div class="box-title">
					<h2><?= htmlspecialchars(tr('smallbox_selected_pack') ?? 'Selected Pack') ?></h2>
				</div>
				<div id="subsc"></div>
			...
			<div class="small-box">
				<div class="box-title">
					<h2><?= htmlspecialchars(tr('smallbox_spot') ?? 'Spot') ?></h2>
				</div>

        ...
        <table width="80%" align="center" cellspacing="0">
            ...
            <tr valign="baseline">
                <td colspan="6" align="center">
                    <h2><?= tr('your_free_trial_has_expired') ?></h2>
                </td>
            </tr>
            <tr valign="baseline">
                <td colspan="6" align="center">
                    <p>
                        <?= tr('trial_expired_desc') ?>
                    </p>
                    <p>
                        <?= tr('trial_expired_warning') ?>
                    </p>
                </td>
            </tr>
            <tr valign="baseline" height="60px">
                ...
                <td width="50%" align="center">
                    <button type="button" class="button-style-agree" id="upgrade-package"><?= tr('upgrade_package') ?></button>
                </td>
            </tr>
        </table>
    </div>

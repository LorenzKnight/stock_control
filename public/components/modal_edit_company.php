			...
			<table width="80%" align="center" cellspacing="0">
				<tr valign="baseline">
					<td colspan="6" align="center" valign="middle">
						<h2><?= $t['add_edit_company_title'] ?></h2>
					</td>      
				</tr>
				<tr valign="baseline">
					<td colspan="3" align="center" valign="middle">
						<div class="formular-category-list">
							<div class="create-list-holder" id="clic-create-mark">
								<button type="button" class="button-style-agree" id="add-aff-btn"><?= $t['create_affiliate'] ?></button>
							</div>
					...
					<td colspan="3" align="center" valign="middle">
						<div class="formular-category-list">
							<table class="hidden" id="company-form" width="100%" align="center" cellspacing="0">
								...
								<tr valign="baseline" class="form_height">
									<td colspan="2" align="center" valign="middle">
										<label for="organization_no"><?= $t['organization_no'] ?>:</label>
								...
								<tr valign="baseline" class="form_height">
									<td width="50%" align="center" valign="middle">
										<label for="company_country_code"><?= $t['company_country_code'] ?>:</label>
										<select class="form-medium-input-style" name="company_country_code" id="company_country_code" required></select>
									</td>
									<td width="50%" align="center" valign="middle">
										<label for="company_phone"><?= $t['company_phone'] ?>:</label>
				...
				<tr valign="baseline" class="form_height">
					...
					<td colspan="3" align="center" valign="middle">
						<input type="submit" class="button-style-agree" id="company-action-btn" value="<?= $t['ok'] ?>" />
					</td>
				</tr>
			</table>
		</form>

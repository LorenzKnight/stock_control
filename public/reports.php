...
$reportsVersion = filemtime($_SERVER['DOCUMENT_ROOT'] . '/js/raports.js');
...
<head>
    ...
    <script defer src="js/raports.js?v=<?= $reportsVersion ?>"></script>
...
<body>
	...
	<?php include("components/reports_container.php"); ?>
</body>

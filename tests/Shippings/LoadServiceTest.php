...
final class LoadServiceTest extends TestCase
{
	...
	public function testRejectsUpdateWithInvalidLoadId(): void
	{
		$repository =
			$this->createMock(
				LoadRepository::class
	...
	public function testRejectsUpdateWhenLoadDoesNotExist(): void
	{
		$repository =
			$this->createMock(
				LoadRepository::class
	...
	public function testRejectsUpdateWithProductFromAnotherCompany(): void
	{
		$repository =
			$this->createMock(
				LoadRepository::class
	...
	public function testUpdatesLoadWithProducts(): void
	{
		$repository =
			$this->createMock(
				LoadRepository::class
				...
				$this->callback(
					function (array $data): bool {
						return
							...
							$data["taxes"] === "10.00" &&
							$data["price_total"] === "49.50" &&
							$data["destination"] === "Göteborg" &&
							$data["comment"] === "Updated load";
					}
				)
			);

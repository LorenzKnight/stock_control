...
<div class="container">
	<div class="data-container" style="height: 780px;">
		...
		<div class="product-table flex">
			...
			<div class="notifications-details" id="notifications-details2">
				<div>
					<table class="message-details" id="messageDetails" width="90%" align="center" cellspacing="0" style="margin-top: 15px;">
						...
						<tr class="form_height" valign="baseline">
							<td width="50%" align="left" valign="middle" style="border-bottom: 1px solid #ccc; padding: 10px 0;"><strong>From:</strong></td>
							<td width="50%" align="right" valign="middle" style="border-bottom: 1px solid #ccc; padding: 10px 0;"><strong>Date: </strong><span id="notif-from-user">2025-07-23</span></td>
						</tr>
						<tr valign="baseline">

							...
							<div class="lists-container">
								<div class="formular-list">
									...
									<div class="cat-all-list">
										<table class="all-mark-list" id="select-edit-shipping-customers-list" cellspacing="0"></table>
									</div>
								</div>
								...
								<div class="formular-list">
									...
									<div class="cat-all-list">
										<table class="all-mark-list" id="edit-select-product-list-for-shipping" cellspacing="0"></table>
									</div>
								</div>

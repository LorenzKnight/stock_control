<div id="globalConfirmModal" class="delete-modal-overlay" style="display: none;" data-nosnippet>
	<div class="delete-modal-box">
		...
		<div class="delete-modal-actions">
			<button id="modalCancelBtn" class="neutral-btn"><?= tr('cancel') ?></button>
			<button id="modalConfirmBtn" class="button-style-agree"><?= tr('confirm') ?></button>
		</div>
	</div>
</div>
...
<div id="globalOkModal" class="delete-modal-overlay" style="display: none;" data-nosnippet>
	<div class="delete-modal-box">
		...
		<div class="confirm-modal-actions">
			<button id="modalOkBtn" class="button-style-agree"><?= tr('ok') ?></button>
		</div>
	</div>
</div>

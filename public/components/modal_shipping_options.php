							...
							<div class="lists-container">
								<div class="formular-list">
									...
									<div class="cat-all-list">
										<table class="all-mark-list" id="select-shipping-customers-list" cellspacing="0"></table>
									</div>
								</div>
								...
								<div class="formular-list">
									...
									<div class="cat-all-list">
										<table class="all-mark-list" id="select-product-list-for-shipping" cellspacing="0"></table>
									</div>
								</div>
										...
										<table width="100%" align="center" cellspacing="0">
											...
											<tr valign="baseline" >
												<td colspan="2" align="center" valign="middle">
													...
													<textarea class="form-input-style" id="comment" name="comment" rows="4" cols="35">
													</textarea>
												</td>
											</tr>
										</table>
